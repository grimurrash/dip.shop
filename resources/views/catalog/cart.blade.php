...
@section('title',"Интернет-магазин Теплогазснаб")
@section('description','Широкий выбор котлов и других отопительных оборудований интернет-магазина Теплогазснаб  по выгодным ценам в Казани')
@push('styles')
