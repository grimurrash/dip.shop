    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 col-lgx-7 cols">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4">
                ...
                <a class="opacity7" href="{{ route('dostavka') }}">Доставка</a>
                <a class="opacity7" href="{{ route('oplata') }}">Оплата</a>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 col-lgx-3 contact">
        <div>
            ...
            <ul class="col-sm-4 col-md-3 col-lg-12 social">
                <li class="fb"><a target="_blank" href="//www.facebook.com/"
                                  rel="nofollow"></a></li>

                <li class="vk"><a target="_blank" href="//vk.com/" rel="nofollow"></a></li>

                <li class="tw"><a target="_blank" href="//twitter.com/" rel="nofollow"></a>
                </li>

                <li class="ok"><a target="_blank" href="//www.odnoklassniki.ru/"
                                  rel="nofollow"></a></li>
