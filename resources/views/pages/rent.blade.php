...
@section('title',"Арендодателям торговых помещение: условия сдачи в аренду помещения ПОЗИТРОНИКА (Казань)")
@section('description','Информация для арендодателей торговых помещение (площадей): Кто хочет сдать в аренду помещение , торговую площадь - условия в компании ПОЗИТРОНИКА (Казань)')
