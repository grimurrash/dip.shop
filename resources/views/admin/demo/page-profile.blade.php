...
@section('title',"Profile | Klorofil - Free Bootstrap Dashboard Template")
                                    ...
                                    <div class="table-responsive">
                                        <table class="table project-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('admin/assets/img/user2.png') }}" alt="Avatar"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('admin/assets/img/user1.png') }}" alt="Avatar"
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('admin/assets/img/user5.png') }}" alt="Avatar"
