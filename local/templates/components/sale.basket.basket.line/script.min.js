...
(function (a) {
    basketPopoverConfig = {
        placement: function (c, b) {
            ...
            return '<div id="js_cart_holder"><div class="row"><div class="col-lg-12"></div></div></div>'
        }, title: function () {
            return '<button type="button" class="close" data-dismiss="popover" aria-hidden="true">&times;</button>'
        }, shown: function () {
            // a("#js_cart_holder").closest(".popover-content").preloader("start");
            // a("#js_cart_holder").closest(".popover-content").preloader("stop")
        //    Корзина !!!! ДОделать
        }
    }
})(jQuery);