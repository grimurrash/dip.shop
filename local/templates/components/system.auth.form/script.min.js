            ...
            a.ajax({
                ...
                error: function (error) {
                    ...
                    errors_keys.forEach((key) => {
                        ...
                        if(key != 'personalData'){
                            $(`<span class="error help-block">${error_message}</span>`).insertAfter('.js_login_form input[name="' + key + '"')
                        }else{
                            $(`<span class="error help-block">${error_message}</span>`).insertBefore('.js_login_form input[name="' + key + '"')
                        }
